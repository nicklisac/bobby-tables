...
* **Label:** `wayfinder:task` (AFK)
* **Status:** 🟢 DONE (2026-08-18, branch `t26.5-harmonization`) — all 5 subsystems consume their 26.4 views; each build-green + harness-green (15/15) + AGY-CLEAN, one commit each.
